      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <ScrollReveal className="max-w-3xl mb-10">
          ...
          <p className="text-slate-600 text-base sm:text-lg leading-relaxed">
            A live feed powered by Gemini with Google Search grounding. Pick a topic or search for
        ...
        {error && !isLoading ? (
          ...
          <>
            ...
            <p className="mt-6 text-xs text-slate-400">
              Updated {new Date(data.generatedAt).toLocaleString()} · Generated by Gemini with Google
              Search grounding. Verify time-sensitive details with the linked sources.
            </p>
          </>
        ) : (
